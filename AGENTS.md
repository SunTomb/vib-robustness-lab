...
- `phase_label`: one of `baseline`, `under-regularized`, `useful-compression`, `robustness-specialized`, `over-compressed`, `unstable`; `baseline` is reserved for CNN reference experiments and is not a VIB compression phase.
