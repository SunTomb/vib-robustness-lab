...
- phase label 计数：`{'baseline': 1, 'under-regularized': 4, 'useful-compression': 6, 'unstable': 1, 'over-compressed': 1}`。
...
- phase label 计数：`{'baseline': 1, 'under-regularized': 2, 'useful-compression': 2, 'unstable': 7, 'over-compressed': 1}`。
...
- phase label 计数：`{'baseline': 1, 'under-regularized': 1, 'useful-compression': 6, 'unstable': 4, 'over-compressed': 1}`。
